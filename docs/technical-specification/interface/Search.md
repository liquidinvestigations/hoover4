...
| `.filters_modal` | "All filters", apply, cancel, clear all | edits every filter at once and commits them together | edits are pending until applied; cancel discards them; the button says how many pending changes it would apply |
