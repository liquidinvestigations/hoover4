...
`ai_services/docker-compose.yaml`, where they were unreadable and drifted from the tool
...
`hoover4_mcp/collection_search_server/collection_search_server/prompts.py`), which is
