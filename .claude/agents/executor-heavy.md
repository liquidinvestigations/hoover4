...
A review writes a correction package. It lists findings, and each finding has a defect class and
a `path:line`. Fix each finding at its cause. Give one report row to each finding, with its class,
