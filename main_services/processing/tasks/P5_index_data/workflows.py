...
class IndexDatasetPlan:
    ...
    async def run(self, params: IndexDatasetPlanParams) -> str:
        ...
        for chunk, pages_res, metadata_res in zip(chunks, pages_results, metadata_results):
            for res, task_id in ((pages_res, "P5_IndexTextPages"), (metadata_res, "P5_IndexMetadata")):
        ...
        log.info(f"[P5] Done: Indexing dataset plan {params.collection_dataset} {params.plan_hash}")
